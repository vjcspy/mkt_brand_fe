...
var ReactPageScroller = function ReactPageScroller(_ref) {
  ...
  var addNextComponent = useCallback(
  ...
  var checkRenderOnMount = useCallback(
    function () {
  ...
  var setRenderComponents = useCallback(
    function () {
  ...
  var scrollWindowUp = useCallback(
    function () {
