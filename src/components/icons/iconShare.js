...
const IconShare = ({ width = 24, height = 24, color = "currentColor" }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M9 10.5L15 7.5" stroke="#7B7979" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M9 13.5L15 16.5" stroke="#7B7979" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
