...
const IconMap = ({ className, color = "currentColor", width = 24, height = 24 }) => {
  return (
    <svg width={width} className={className} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
